...
(function(){
  ...
  function log() {
    if (typeof console !== "undefined" && console.log) {
      var args = ["[Strimix]"].concat(Array.prototype.slice.call(arguments));
